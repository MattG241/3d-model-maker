# Parts Plugin (in-Studio, Part-based)

> This is the original **in-Studio plugin** that builds models out of Roblox
> **Parts**. For the newer **prompt → JSON → detailed `.obj` mesh** pipeline,
